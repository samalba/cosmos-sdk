...
func PrintUnsignedStdTx(w io.Writer, txBldr authtxb.TxBuilder, cliCtx context.CLIContext, msgs []sdk.Msg, offline bool) error {
	var (
		stdTx auth.StdTx
		err   error
	)
