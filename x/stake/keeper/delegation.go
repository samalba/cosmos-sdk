...
func (k Keeper) RemoveDelegation(ctx sdk.Context, delegation types.Delegation) {
	k.PreDelegationRemoved(ctx, delegation.DelegatorAddr, delegation.ValidatorAddr)
	store := ctx.KVStore(k.storeKey)
...
func (k Keeper) Delegate(ctx sdk.Context, delAddr sdk.AccAddress, bondAmt sdk.Coin,
	...
	if found {
		k.PreDelegationSharesModified(ctx, delAddr, validator.OperatorAddr)
	} else {
		k.PreDelegationCreated(ctx, delAddr, validator.OperatorAddr)
	}
...
func (k Keeper) unbond(ctx sdk.Context, delAddr sdk.AccAddress, valAddr sdk.ValAddress,
	...
	k.PreDelegationSharesModified(ctx, delAddr, valAddr)
